...
<%@ page import="es.uma.proyectotaw.entity.TipoentrenamientoEnum" %>
...
<body>
    <nav>
        ...
        <ul class="enlaces">
            ...
            <li><a href="trabaja" id="activo">Trabaja con Nosotros</a></li>
    ...
    <div class="imagen-fondo">
        ...
        <div class="contenido">
            ...
            <form action="/registerEntrenador" method="post" id="form" name="form" class="home-form">
                ...
                <h1 class="home-text02">
                    <span>¿Qué tipo de entrenador eres?</span><br />
                </h1>
                <div id="TipoEntrenador" class="home-container08">
